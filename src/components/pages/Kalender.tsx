...
export default function Kalender({ search }: { search: string }) {
  const { customers, serviceEvents, openTasks } = useAppStore();
          ...
          <SectionHeader
            ...
            action={
              <div className="flex gap-2">
                ...
                <button className="btn btn-primary" onClick={() => setCreateServiceOpen(true)}>
